<template>
	<div class="navbar">
		...
		<!-- 系统通知-1 -->
		<el-button class="notice" @click="dialogVisible = true" :style='{"border":"0","cursor":"pointer","padding":"0 12px","outline":"none","margin":"0 10px 0 0","color":"#737373","borderRadius":"4px","background":"none","width":"auto","fontSize":"16px","height":"40px","order":"4"}' type="success">
		  <span class="icon iconfont icon-gonggao8" :style='{"margin":"0 2px","fontSize":"32px","color":"#bababa","height":"24px"}'></span>
