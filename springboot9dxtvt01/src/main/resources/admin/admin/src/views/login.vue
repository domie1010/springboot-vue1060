<template>
  <div>
    <div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231022/32f7bf7edcdc4036b69e97823b37b46b.jpg)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
      <el-form :style='{"border":"0px solid #f6f6f6","padding":"60px 60px 120px 160px","boxShadow":"0 0px 0px rgba(0, 0, 0, .1)","margin":"0 auto","alignItems":"flex-start","textAlign":"center","display":"flex","minHeight":"600px","borderRadius":"0","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231022/3e8de650473a498b9c1847c1f65282f7.png) no-repeat center top / 100% 100%","width":"600px","fontSize":"14px","position":"relative","height":"auto"}'>
        <div v-if="true" :style='{"padding":"0px","margin":"0 0 20px","borderColor":"#ddd","color":"#fff","textAlign":"center","display":"inline-block","background":"none","borderWidth":"0px","width":"300px","lineHeight":"1.5","fontSize":"16px","borderStyle":"solid","fontWeight":"500"}' class="title-container">基于Springboot的学生答题练习在线平台登录</div>
        <div v-if="loginType==1" class="list-item" :style='{"width":"300px","margin":"0 0 20px 0","position":"relative","alignItems":"center","flexWrap":"wrap","display":"flex"}'>
		...
		<div class="list-item select" :style='{"width":"300px","margin":"0 0 20px 0","position":"relative","alignItems":"center","flexWrap":"wrap","display":"flex"}' v-if="roles.length>1">
			<div v-if="true" class="lable" :style='{"color":"#ccc","left":"-100px","textAlign":"right","width":"100px","lineHeight":"44px","fontSize":"inherit","position":"absolute"}'>角色：</div>
        ...
        <div :style='{"margin":"0","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"300px","fontSize":"16px","justifyContent":"center"}'>
          <el-button v-if="loginType==1" :style='{"border":"0","cursor":"pointer","padding":"0 20px","margin":"0 20px 0 0","color":"#fff","textAlign":"right","letterSpacing":"4px","outline":"none","borderRadius":"0px","background":"#ffb901","width":"auto","fontSize":"14px","height":"32px","order":"2"}' type="primary" @click="login()" class="loginInBt">登录</el-button>
          <el-button :style='{"border":"0px solid rgba(64, 158, 255, 1)","cursor":"pointer","padding":"0 16px","margin":"0 0px 20px","borderColor":"rgba(167,142,68,1)","color":"#fff","textAlign":"left","clipPath":"polygon(100% 0, 100% 20%, 93% 50%, 100% 80%, 100% 100%, 0 100%, 0 0)","outline":"none","borderRadius":"0px","background":"#ffb901","borderWidth":"0px","width":"100%","fontSize":"14px","borderStyle":"solid","fontWeight":"500","height":"44px"}' type="primary" @click="register('xuesheng')" class="register">注册学生</el-button>
        </div>
      </el-form>
